				...
				<div class="panel panel-default">
					<div class="panel-heading">Actions</div>
						<div class="panel-body">
							...
							<?php echo "\t\t<li><?php echo \$this->Html->link(__('<span class=\"fa fa-edit\"></span>&nbsp&nbsp;Edit " . $singularHumanName ."'), array('action' => 'edit', \${$singularVar}['{$modelClass}']['{$primaryKey}']), array('escape' => false)); ?> </li>\n";
...
<?php echo "<?php endif; ?>\n\n"; ?>
	<div class="actions">
		<?php echo "<?php echo \$this->Html->link('<span class=\"fa fa-plus\"></span>&nbsp;&nbsp;.'__('New " . Inflector::humanize(Inflector::underscore($alias)) . "'), array('controller' => '{$details['controller']}', 'action' => 'add'), array('escape' => false, 'class' => 'btn btn-default')); ?>"; ?>
	</div>
	</div><!-- end col md 12 -->
</div>
<?php endforeach; ?>
