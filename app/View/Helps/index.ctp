				...
				<tbody>
					...
					<tr>
						...
						<td><?php echo h($help['Help']['slug']); ?>&nbsp;</td>
								<td>
			<?php echo $this->Html->link($help['User']['name'],
									array('controller' => 'users', 'action' => 'view', $help['User']['id'])); ?>
		</td>
					 ...
					 'data-title'=>__('view').' '.$help['Help']['id'],'data-toggle'=>'tooltip','data-placement'=>'bottom')); ?>
						</td>
						<td class="actions">
							<?php echo $this->Html->link('<span class="icon-pencil"></span>',
					 array('action' => 'edit', ),
					 array('class'=>'btn btn-default','escape' => false,
					  'data-title'=>__('edit').' '.$help['Help']['id'],'data-toggle'=>'tooltip','data-placement'=>'bottom')); ?>
						</td>
						<td class="actions">
							<p data-placement='bottom' data-toggle='tooltip' title='<?= __('delete');?>' class='text-center'>
