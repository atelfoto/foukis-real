<?php echo $this->assign('title', __('status')); ?>
 <?php $this->Html->addCrumb(__('status'),array('controller'=>'statuses','action'=>'index','admin'=>true)); ?>
 <?php $this->Html->addCrumb('edit' ); ?>
<div class="statuses index row">
	<div class="col-sm-12 page-header">
		<h3><i class="icon-statuses"></i>&nbsp;<?php echo __('Admin Edit Status'); ?>		</h3>
	</div>
	<div class="col-sm-12">
			...
			<ul class="nav nav-tabs" role="tablist">
				...
				<li class='pull-right'>
					<?php echo $this->html->link('<i class="icon-cancel-circled" style="color:#f00;">&nbsp;</i>'.__('closed'),
							array('controller'=>'statuses','action'=>'index'),
