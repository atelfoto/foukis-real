...
<div class="menus index row">
	<div class="col-md-12 page-header">
		<h2><i class="fa fa-book"></i>&nbsp;<?php echo __('Admin Edit Menu'); ?>		</h2>
	</div>
...
tinyMCE.init({
 ...
 table_class_list: [
  ...
  table_appearance_options: false,
    image_explorer :'<?php echo $this->Html->url(array('controller'=>'medias','action'=>'index', $this->request->data['Menu']['id'])); ?>',
